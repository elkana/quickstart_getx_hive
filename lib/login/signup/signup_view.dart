      ...
      appBar: AppBar(
        ...
        actions: [
          kReleaseMode
              ? const SizedBox()
              : TextButton(
                  onPressed: controller.test('elkana911', 'elkana911'),
                  ...
                  child: Form(
                      child: Column(children: <Widget>[
                        ...
                        TextFormField(
                            ...
                            onSaved: (val) =>
                                controller.ctrlFullname.text = val!,
                        ...
                        Obx(() => TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                suffixIcon: IconButton(
                                    ...
                                    onPressed: () =>
                                        controller.obscurePwdNew.toggle()),
                        ...
                        Obx(() => TextFormField(
                            ...
                            validator: (val) =>
                                controller.validatePassword(val!),
                            onSaved: (val) =>
                                controller.ctrlConfirmPwd.text = val!,
                            style: const TextStyle(fontWeight: FontWeight.bold),
                            decoration: InputDecoration(
                                labelText: 'Confirm Password',
                                suffixIcon: IconButton(
                                    icon: Icon(
                                        controller.obscurePwdConfirm.isTrue
                                            ? Icons.visibility_off_outlined
                                            : Icons.visibility_outlined),
                                    onPressed: () =>
                                        controller.obscurePwdConfirm.toggle()),
                                contentPadding: const EdgeInsets.fromLTRB(
                                    20.0, 20.0, 20.0, 10.0)),
